...
//		 * // testing with strings
		...
		System.out.println("\nTrio is a triplicate? true:  " + wordTrio.isATriplicate());
...
//		wordTrio.setItem2(3);
	...
	public static Stack<Integer> createReverseStack(Stack<Integer> originalStack) {
		// YOUR CODE HERE
		Stack<Integer> stackCopy = new Stack<Integer>();
		Stack<Integer> restoreStack = new Stack<Integer>();

		while (!originalStack.isEmpty()) {
			stackCopy.push(originalStack.pop());
			restoreStack.push(stackCopy.peek());

		}

		while (!restoreStack.isEmpty()) {
			originalStack.push(restoreStack.pop());
		}
